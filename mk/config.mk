...
# The two 8086 run loops compared on the machine (verify-irun).
UIRUN	= $(UOBJDIR)/IRUNT.Z8K
...
UPROGS3	= $(UOBJDIR)/MSCOPY.Z8K $(UOBJDIR)/ERRTEST.Z8K \
	  ...
	  $(UOBJDIR)/U0T.Z8K $(UOBJDIR)/ROT.Z8K \
	  $(UOBJDIR)/BIOSET.Z8K $(UOBJDIR)/CONBRK.Z8K \
	  $(UOBJDIR)/V3RET.Z8K $(UOBJDIR)/V3FREE.Z8K $(UOBJDIR)/RANEXT.Z8K \
	  $(UOBJDIR)/CPMSYST.Z8K $(UOBJDIR)/SSTKT.Z8K
