...
char *argv[];
{
	...
	cputs("\r\n");
	/*
	 * The argument echo goes out through fn 2 (conputs), not fn 111, so
	 * that the "both fn 9 and fn 2" above stays true and so that an
	 * unrelated program's console output is there for a resident module
	 * to fold.  An RSX hooks the BDOS entry; fn 111 is
