...
char *argv[];
{
	...
	/*  HOW MANY PROCESSES THERE WERE BEFORE.  The cold boot starts a
	    session on every other console, so the floor is whatever was
	    already live; waiting for a literal 1 never ends.  */
