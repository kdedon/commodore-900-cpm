/* -*-c,save-*- */
/* PORT NOTE.  The copy of this file in cpm68k_pgms ends with seven lines
   of a duplicated, truncated tail after the final brace -- the second
   half of put_hex() again, cut off mid-printf.  Archive damage, not
   code; it is removed here and nothing else is changed.  (c900) */
