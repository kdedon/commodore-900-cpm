...
#define		PATHMAX		8	/* search path groups	   */
#define		NDMAX		8	/* named directories	   */
#define		NDNAME		8	/* chars in a config name  */
#define		CFGLINE		64	/* CCP.CFG line length	   */
#define		IFMAX		8	/* IF/ELSE/FI nesting	   */
#define		DUBAD		0xFFFE	/* malformed/unknown dU	   */
#define		CURDU		0xFF	/* "the one now in effect" */
#define		F_EXEC		0	/* branch state: executing */
#define		F_SKIP		1	/* branch state: skipping  */
#define		F_DEAD		2	/* branch state: skipping, */
					/*  and ELSE skips too	   */
#define		ERRLINE		130	/* saved failing command    */

	/* Command-file search hit types (cmd_file group flags) */
#define		T_Z8K		1	/* NAME.Z8K		   */
#define		T_BLANK		2	/* NAME with a blank type  */
#define		T_SUB		4	/* NAME.SUB		   */
#define		T_ANY		7
...
#define		PROG_RC		108	/* get/set program return code	   */
#define		RC_GET		0xFFFF	/*  fn 108 parameter that reads it */
					/*  (see ccp_err() in ccpext.c)	   */
