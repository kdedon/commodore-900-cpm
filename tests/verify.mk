...
I86SRC = src/cmd/i86dec.c src/cmd/i86exec.c src/cmd/i86load.c \
	 src/cmd/i86bdos.c src/cmd/gdpb.c
I86CORPUS = tests/i86corpus
I86FIX = build/cmdfix
.PHONY: i86test
build/i86test: tests/i86test.c $(I86SRC) src/cmd/i86.h src/cmd/gdpb.h | $(OBJDIR)
...
Z80SRC = src/cmd/z80dec.c src/cmd/z80exec.c src/cmd/z80load.c \
	 src/cmd/z80bdos.c src/cmd/gdpb.c
Z80CORPUS = tests/z80corpus
.PHONY: z80test
build/z80test: tests/z80test.c $(Z80SRC) src/cmd/z80.h src/cmd/gdpb.h | $(OBJDIR)
...
build/z80test-asan: tests/z80test.c $(Z80SRC) src/cmd/z80.h src/cmd/gdpb.h | $(OBJDIR)
	$(HOSTCC) -std=gnu89 -w -DHOSTCC -fsanitize=address -g -o $@ \
		tests/z80test.c $(Z80SRC)
build/i86test-asan: tests/i86test.c $(I86SRC) src/cmd/i86.h src/cmd/gdpb.h | $(OBJDIR)
	$(HOSTCC) -std=gnu89 -w -DHOSTCC -fsanitize=address -g -o $@ \
	...
	@timeout 300 ./build/i86test-asan $(I86CORPUS) $(I86FIX) > build/verify-shim-i86.log 2>&1; \
	 ...
	 test $$rc = 0 \
		|| { echo "verify-shim: FAIL -- the CP/M-86 shim (rc $$rc; 124 means it"; \
		     ...
		     exit 1; }
	@grep -q 'z80test: 828 checks, 0 failures' build/verify-shim-z80.log \
		|| { echo "verify-shim: FAIL -- the CP/M-80 suite did not run all 828 of its"; \
